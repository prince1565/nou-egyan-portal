<!-- top row contact and email start -->
    ...
    <div class="row col-sm-12" style="background-color:  #a3a3ad ">
          ...
          <nav class="navbar navbar-expand-lg navbar-dark ">
            ...
            <ul class="navbar-nav mx-5 me-0">
            <li class="nav-item">
            <a class="nav-link text-light" style="font-size: 1.25rem;" href="adminhome.jsp"><i class="bi bi-book-half"></i>Home</a>
            </li>
            <li class="nav-item">
            <a class="nav-link text-light" style="font-size: 1.25rem;" href="studentinfo.jsp"><i class="bi bi-book-half"></i>Student Management</a>
            </li>
            <li class="nav-item">
            <a class="nav-link text-light" style="font-size: 1.25rem;" href="enquirymgmt.jsp"><i class="bi bi-textarea-t"></i> Enquiry Management</a>
            </li>
            <li class="nav-item">
            <a class="nav-link text-light" style="font-size: 1.25rem;" href="feedbackmgmt.jsp"><i class="bi bi-mortarboard-fill"></i>Feedback Management</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-light" style="font-size:1.25rem;" href="complainmgmt.jsp"><i class="bi bi-book-half"></i> Complain Management</a>
              </li>
              <li class="nav-item">
              <a class="nav-link text-light" style="font-size:1.25rem;" href="uploadmaterial.jsp"><i class="bi bi-book-half"></i>Study Material</a>
              </li>
              <li class="nav-item">
              <a class="nav-link text-light" style="font-size:1.25rem;" href="changepassword.jsp"><i class="bi bi-book-half"></i>Change Password</a>
              </li>
              <li class="nav-item">
              <a class="nav-link text-light" style="font-size: 1.25rem;" href="logout.jsp"><i class="bi bi-book-half"></i> Logout</a>
              </li>
            </ul>
            </div>
            </div>
