    ...
    <body>
        <jsp:include page="header.jsp"/>
            ...
            <div class="row  col-sm-12" style="background-color: #ccccff;">
                <br><h1 style="text-align: center">Feedback Management</h1><br><br><br><br><br>
                <table class="table" style="width: 95%; margin: auto;" >
                    ...
                    <%
                     ...
                     <tr>
                         ...
                         <td>
                             <a href="delfeedback.jsp?id=<%=rs.getInt("id")%>"><button type="button" class="btn btn-danger">Delete</button></a>
                         </td>
